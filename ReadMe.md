...
==========
~~[wheel (GitLab)](https://gitlab.com/KOLANICH-libs/IPLists.py/-/jobs/artifacts/master/raw/dist/IPLists-0.CI-py3-none-any.whl?job=build)~~
[wheel (GHA via `nightly.link`)](https://nightly.link/KOLANICH-libs/IPLists.py/workflows/CI/master/IPLists-0.CI-py3-none-any.whl)
~~![GitLab Build Status](https://gitlab.com/KOLANICH-libs/IPLists.py/badges/master/pipeline.svg)~~
~~![GitLab Coverage](https://gitlab.com/KOLANICH-libs/IPLists.py/badges/master/coverage.svg)~~
